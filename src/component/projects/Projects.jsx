...
export class Projects extends Component {
   ...
   *
   * @description
   * This component renders the Projects section of the site. It contains a
   * title, description, a grid of ProjectCards, and a call-to-action to get in
   * touch. The Projects section is translated using the i18next library.
   */
  render() {
